                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{route('events.create')}}" type="button" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table text-center table-nowrap">
                                        ...
                                        @forelse($data as $i=>$item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($item->image != '')
                                                        <img src="{{asset('storage/images/event/'.$item->image)}}" alt="" width="120" height="100">
                                                    @else
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="edit">
                                                            <a class="btn btn-sm btn-success edit-item-btn" href="{{route('events.edit',$item->id)}}"><i class="ri-edit-circle-line"></i></a>
                                                        </div>
                                                        <div class="remove">
                                                        ...
                                                        <form action="{{ route('events.destroy',$item->id)}}" class="d-none deleteForm{{$item->id}}" method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                        </form>
                                                    </div>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center h3">There is no Event !</td>
                                            </tr>
                                        @endforelse
                                        </tbody>
                                    </table>
