                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{route('credit-points.create')}}" type="button" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table text-center table-nowrap">
                                        ...
                                        @forelse($data as $i=>$item)
                                            <tr>
                                                <td>{{$i+1}}</td>
                                                <td>
                                                    {{ $item->point }} @if ($item->point == 1) point @else points @endif
                                                </td>
                                                <td>
                                                    {{ $item->price }} Kyats
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="edit">
                                                            <a class="btn btn-sm btn-success edit-item-btn" href="{{route('credit-points.edit',$item->id)}}"><i class="ri-edit-circle-line"></i></a>
                                                        </div>
                                                        <div class="remove">
                                                        ...
                                                        <form action="{{ route('credit-points.destroy',$item->id)}}" class="d-none deleteForm{{$item->id}}" method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                        </form>
                                                    </div>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center h3">There is no points !</td>
                                            </tr>
                                        @endforelse
                                        </tbody>
                                    </table>
